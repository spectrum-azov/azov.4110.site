        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <p>
                У Трійці є місце для кожного. Наша ціль — створити умови, де аси своєї справи роблять те, що вміють найкраще. Ми формуємо спільноту професіоналів, які працюють на результат, а їхні знаття та досвід ламають плани ворога.
              </p>
              <p>
